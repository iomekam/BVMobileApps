...
namespace BVMobileAppsApi.Controllers
{
    ...
    public class AppSetupController : Controller
    {
        ...
        public AppSetupController(IAppSetupRepository appSetupRepository)
        {
        ...
        // GET: api/values
        [HttpGet]
        public IEnumerable<AppSetup> Get()
        {
            return _appSetupRepository.GetAll();
        }

        // GET api/values/5
        [HttpGet("{id}")]
        public AppSetup Get(int id)
        {
            return _appSetupRepository.Find(id);
        }
