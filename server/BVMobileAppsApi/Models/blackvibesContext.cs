...
namespace BVMobileAppsApi.Models
{
    public partial class blackvibesContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=tcp:iomekam.database.windows.net,1433;Initial Catalog=blackvibes;Persist Security Info=False;User ID=iomekam3;Password=04051993@Q1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Images>(entity =>
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__Images__7516F70C891A4796");
